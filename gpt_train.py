...
Original file is located at
    https://colab.research.google.com/drive/1JvuYaMBWqCO-NMXzYs7Radud8zVNDaXY
"""
...
for iteration in range(max_iters):
    ...
    if not (iteration % eval_interval):
        ...
        print(f"stop {iteration} training loss {losses['train']:.4f}, validation loss {losses['val']:.4f}")
...
# Generate from model
prompt = "Here lies Achilles, the great son of"
tokens_to_generate = 500
context = torch.tensor((encode(prompt), encode(prompt)), dtype=torch.long, device=device)
